...
Delta specs describe **what changes** relative to the current source of truth. They live in `soia-spec/changes/{feature}/specs/{domain}/spec.md` and are applied to `soia-spec/specs/{domain}/spec.md` on archive.
...
1. Check if `soia-spec/specs/{domain}/spec.md` exists.
